...
public class View extends JFrame implements IObserverMV{
    ...
    // LABELS
        ...
        spinner_TempTarget.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                System.out.println("Current consigne = "+val);
                setConsigne(val);
                //if (val == 15) {
    ...
    private TraceurCourbes courbe;
    public void SetCourbe(TraceurCourbes tc) {
    	courbe = tc;
    }
    ...
    public void NotifyMV(IObservableMV observable) {
        ...
        if(((Model)observable).getRawFrigo(0).getTempInt()>((Model)observable).getRawFrigo(0).getConsigne()) {
        	lbl_Statut.setText("Refroidissement en cours");
        } else {
        	lbl_Statut.setText("Consigne atteinte");
        }
        courbe.AjouterTemp(((Model)observable).getRawFrigo(0).getTempInt());
    }
}
